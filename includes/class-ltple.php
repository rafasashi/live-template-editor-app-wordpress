...
class LTPLE_App_Wordpress extends LTPLE_Client_App {

	/**
	 * The single instance of LTPLE_App_Wordpress.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function __construct ( $file='', $parent, $version = '1.0.0' ) {
		...
		$this->settings = new LTPLE_App_Wordpress_Settings( $this->parent );
		
		$this->admin = new LTPLE_App_Wordpress_Admin_API( $this );
		...
		$apps = $this->parent->apps->get_terms( 'app-type', array(
			...
			'wordpress' => array(
				...
				'options' 	=> array(
					...
					'thumbnail' => $this->assets_url . 'wordpress.png',
	...
	public function get_user_profile_url($app){
		...
		return 'https://' . $app->user_name . '.wordpress.com';
	}						
	...
	/**
	 * Main LTPLE_App_Wordpress Instance
	 *
	 * Ensures only one instance of LTPLE_App_Wordpress is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see LTPLE_App_Wordpress()
	 * @return Main LTPLE_App_Wordpress instance
	 */
